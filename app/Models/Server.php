...
class Server extends Model
{
    ...
    public function serverRcon(): BelongsTo {
        return $this->belongsTo(ServerRcon::class, "id", "server_id");
    }

    public function serverRconHistory(): HasMany {
        return $this->hasMany(ServerRconHistory::class);
    }
