...
class StoreServer extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "server_site" => "active_url",
            "server_vk" => "active_url",
            "server_discord" => "active_url",
            "server_ip" => "required",
            "server_banner" => "mimes:jpeg,jpg,png,gif|dimensions:width=486,height=60|size:2048",
            "filters_input" => "array",
    ...
    public function messages(): array
    {
        return [
            ...
            "server_ip" => "Адрес сервера должен быть заполнен.",
