        ...
        <div class="flex justify-center mt-5">
            <div class="mb-3 xl:w-9/12">
                <div class="input-group relative flex flex-wrap items-stretch w-full mb-4" id="search-input">
                    <input type="search" class="form-control h-12 relative flex-auto min-w-0 block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 !rounded-tl-lg transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Введите свой вопрос..." aria-label="Search" aria-describedby="button-addon2" name="search-input">
    ...
    <div class="flex flex-col lg:flex-row justify-center lg:justify-around mb-12 mx-4 lg:mx-24">
        <div class="bg-white shadow-2xl py-16 text-center max-w-sm rounded-3 my-5 mx-auto">
            ...
            <div class="px-10 my-5 h-25">
                <span class="text-[1rem] text-gray-500">Воспользуйтесь нашим ботом Telegram для создания обращения и быстрого ответа на него. Наши администраторы помогут вам в кратчайшие сроки.</span>
            </div>
            <div>
                <a href="https://t.me/mnsgame_bot">
...
{{--        </div>--}}
        <div class="bg-white shadow-2xl py-16 text-center max-w-sm rounded-3 my-5 mx-auto">
            ...
            <div class="px-10 my-5 h-25">
                <span class="text-[1rem] text-gray-500">Попробуйте найти ответ на свой вопрос в базе знаний нашего проекта. Вам не придется ждать ответ, если на него уже есть ответ. </span>
            </div>
            <div>
