...
@section("body")
    ...
    <div class="container max-w-2xl lg:mx-auto mb-12">
            ...
            <div class="h-24 lg:h-20 bg-white shadow-md my-2 py-[20px] pr-[24px] flex flex-row hover:border-b-2 hover:border-indigo-500 transition ease-in-out duration-300 hover:shadow-lg">
                <div class="basis-[96px] items-center h-full flex border-r">
                    <svg class="w-6 h-6 mx-auto" viewBox="0 0 458.18 458.18">
                        <g>
                            <path class="fill-current text-rose-500" d="M36.09,5.948c-18.803,0-34.052,15.248-34.052,34.051c0,18.803,15.249,34.052,34.052,34.052 c18.803,0,34.052-15.25,34.052-34.052C70.142,21.196,54.893,5.948,36.09,5.948z"/>
                            <path class="fill-current text-rose-500" d="M147.537,80h268.604c22.092,0,40-17.908,40-40s-17.908-40-40-40H147.537c-22.092,0-40,17.908-40,40S125.445,80,147.537,80z"/>
                            <path class="fill-current text-rose-500" d="M36.09,132.008c-18.803,0-34.052,15.248-34.052,34.051s15.249,34.052,34.052,34.052c18.803,0,34.052-15.249,34.052-34.052 S54.893,132.008,36.09,132.008z"/>
                            <path class="fill-current text-rose-500" d="M416.142,126.06H147.537c-22.092,0-40,17.908-40,40s17.908,40,40,40h268.604c22.092,0,40-17.908,40-40 S438.233,126.06,416.142,126.06z"/>
                            <path class="fill-current text-rose-500" d="M36.09,258.068c-18.803,0-34.052,15.248-34.052,34.051c0,18.803,15.249,34.052,34.052,34.052 c18.803,0,34.052-15.249,34.052-34.052C70.142,273.316,54.893,258.068,36.09,258.068z"/>
                            <path class="fill-current text-rose-500" d="M416.142,252.119H147.537c-22.092,0-40,17.908-40,40s17.908,40,40,40h268.604c22.092,0,40-17.908,40-40 S438.233,252.119,416.142,252.119z"/>
                            <path class="fill-current text-rose-500" d="M36.09,384.128c-18.803,0-34.052,15.248-34.052,34.051s15.249,34.053,34.052,34.053c18.803,0,34.052-15.25,34.052-34.053 S54.893,384.128,36.09,384.128z"/>
                            <path class="fill-current text-rose-500" d="M416.142,378.18H147.537c-22.092,0-40,17.908-40,40s17.908,40,40,40h268.604c22.092,0,40-17.908,40-40 S438.233,378.18,416.142,378.18z"/>
                        </g>
                    </svg>
                </div>
        ...
        <a href="{{ asset("addserver") }}">
            <div class="h-24 lg:h-20 bg-white shadow-md my-2 py-[20px] pr-[24px] flex flex-row hover:border-b-2 hover:border-indigo-500 transition ease-in-out duration-300 hover:shadow-lg">
                <div class="basis-[96px] items-center h-full flex border-r">
                    <svg class="w-8 h-8 mx-auto" viewBox="0 0 52 52"><path class="fill-current text-indigo-500" d="M50,24H28V2a2,2,0,0,0-4,0V24H2a2,2,0,0,0,0,4H24V50a2,2,0,0,0,4,0V28H50a2,2,0,0,0,0-4Z"/></svg>
                </div>
                <div class="basis-full pl-6">
                    <header class="font-extrabold text-lg mb-1 text-center mr-16 lg:mt-2">
        ...
        <a href="{{ asset("notifications") }}">
            <div class="h-24 lg:h-20 bg-white shadow-md my-2 py-[20px] pr-[24px] flex flex-row hover:border-b-2 hover:border-indigo-500 transition ease-in-out duration-300 hover:shadow-lg">
                <div class="basis-[96px] items-center h-full flex border-r">
                    <svg class="w-10 h-10 mx-auto" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle class="fill-current text-green-500" cx="18" cy="6" r="3"/><path class="fill-current text-green-500" d="M18 19H5V6h8c0-.712.153-1.387.422-2H5c-1.103 0-2 .897-2 2v13c0 1.103.897 2 2 2h13c1.103 0 2-.897 2-2v-8.422A4.962 4.962 0 0 1 18 11v8z"/></svg>
                </div>
                <div class="basis-full pl-6">
                    <header class="font-extrabold text-lg mb-1 text-center mr-16 lg:mt-2">
                        Уведомления
