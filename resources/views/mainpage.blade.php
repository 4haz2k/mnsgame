        ...
        <div class="grid lg:grid-cols-2">
            <div id="firstColumn" class="lg:mt-[-35px] mt-[50px]">
                ...
                <div class="mx-auto mt-5 text-gray-500 mt-12 max-w-lg text-center lg:text-lg">
                    ...
                    <div class="relative font-bold text-xl mt-6 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block">Играй в удовольствие, а MNS Game поможет в этом!</div>
                </div>
        ...
        <div class="container max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
                ...
                <div class="relative flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                    ...
                    <p class="text-base text-left text-gray-500">В нашем сервисе очень легко и удобно можно найти проект по интересующей игре или разместить свой проект и управлять им.</p>
                </div>
                ...
                <div class="flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 sm:rounded-xl">
                    ...
                    <p class="text-base text-left text-gray-500">Поднимая свой проект в рейтинге вы можете быть уверены, что ваш проект не останется без внимания и привлечет к себе игроков.</p>
                </div>
                ...
                <div class="flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 sm:rounded-xl">
                    ...
                    <p class="text-base text-left text-gray-500">На MNS Game большое количество игр и проектов на любой вкус. Вы можете выбрать проект по фильтрам на свое усмотрение в разделе "Игры".</p>
                </div>
            </div>
        </div>
    </section>
