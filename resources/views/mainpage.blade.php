        ...
        <div class="grid lg:grid-cols-2">
            <div id="firstColumn" class="lg:mt-[-35px] mt-[50px]">
                ...
                <div class="mx-auto mt-5 text-gray-500 mt-12 max-w-lg text-center lg:text-lg">
                    MNS Game - это проект, который стремится облегчить жизнь игрокам и администраторам серверов.<br>
                    Игроки могут найти сервер по своим интересам, используя категории и фильтры для поиска, а администраторы используя минимальное количество сил и времени могут раскрутить свой сервер и вывести его в лидеры!<br>
                    <span class="relative font-bold text-xl mt-6 text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 to-indigo-500 md:inline-block">Play for fun, and the MNS will help you with this!</span>
                </div>
            ...
            <div id="secondColumn" class="lg:mt-[40px] hidden lg:block">
                <div class="slider">
