    ...
    <section class="py-20 mns-background2">
        <div class="container max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-4 gap-8 mt-10 sm:grid-cols-8 lg:grid-cols-12 sm:px-8 xl:px-0">
                ...
                <div class="relative flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 overflow-hidden sm:rounded-xl">
                    ...
                    <h4 class="text-xl font-medium text-gray-700 inline">Удобство и простота</h4>
                    <p class="text-base text-left text-gray-500">На проекте очень легко и удобно можно найти сервер по интересующей игре или разместить свой сервер и управлять им.</p>
                </div>
                ...
                <div class="flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 sm:rounded-xl">
                    ...
                    <p class="text-base text-left text-gray-500">Поднимая свой сервер в рейтинге вы можете быть уверены, что ваш сервер не останется без внимания и привлечет к себе игроков.</p>
                </div>
                ...
                <div class="flex flex-col items-start justify-between col-span-4 px-8 py-12 space-y-4 sm:rounded-xl">
                    ...
                    <p class="text-base text-left text-gray-500">К своему серверу вы можете привязать систему поощрений, которая будет отправлять вам ответ о голосе за ваш сервер.</p>
                </div>
